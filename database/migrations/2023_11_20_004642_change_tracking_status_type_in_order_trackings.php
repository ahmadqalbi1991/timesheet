...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('booking_status_trackings', function (Blueprint $table) {
            ...
            $types = ['request_created','accepted','journey_started','item_collected','on_the_way','border_crossing','custom_clearance','delivered','collected_from_shipper','cargo_cleared_at_origin_border','cargo_tracking','cargo_reached_destination_border','cargo_cleared_destination_customs','delivery_completed'];
        ...
        Schema::table('bookings', function (Blueprint $table) {
            ...
            $types = ['pending','qoutes_received','on_process','cancelled','completed','collected_from_shipper','cargo_cleared_at_origin_border','cargo_tracking','cargo_reached_destination_border','cargo_cleared_destination_customs','delivery_completed',];
            $result = join( ', ', array_map(function ($value){
                return sprintf("'%s'::character varying", $value);
            }, $types));
