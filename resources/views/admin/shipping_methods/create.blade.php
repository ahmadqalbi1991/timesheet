...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ route('shipping_methods.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label>Shipping Method Name<b class="text-danger">*</b></label>
                            <input type="text" name="name" class="form-control" required
                                data-parsley-required-message="Enter Shipping Method Name" value="{{ $name }}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Shipping Method Icon</label><br>
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = "{{ route('shipping_methods.list') }}";
                                },1500);
