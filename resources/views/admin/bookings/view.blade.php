                    ...
                    <div class="col-md-12 col-sm-12 py-4">
                            ...
                            <div class = "row">
                                <div class = "col-md-8">
                                    ...
                                    <textarea class="form-control-plaintext" rows = "11" readonly>{{ $booking->delivery_note }}</textarea>
                                </div>

                                <div class = "col-md-4">
                                    <label class="form-label">Customer Signature</label>
                                    @if($booking->customer_signature != null && $booking->customer_signature != 0)
                                        <img src = "{{ asset('storage/bookings/'.$booking->customer_signature) }}" width = "200">
                                    @else
                            ...
                            <div class = "row">
                                <div class = "col-md-4">
                                    ...
                                    <table class = "table table-striped">
                                        ...
                                        <tr>
                                            @if($tracking->status_tracking == 'qouted')
                                            <th>DRIVERS QUOTED: </th>
                                    ...
                                    @if(isset($booking->driver->id) && $booking->driver->id != null)
                                        <div class="text-left">
                                                ...
                                                <a href = "{{ route('drivers.view',['id' => encrypt($booking->driver->id)]) }}">
                                                    <h6 class="mt-0">{{ $booking->driver->name ?? ''}}</h6>
                                                    <p class="text-muted mb-1"> {{ $booking->driver->email ?? ''}} </p>
                                                    <p class="text-muted mb-4">{{ '+'.$booking->driver->dial_code." ".$booking->driver->phone ?? ''}}</p>                                                     
                                                </a>                                                            
                                                    @if($booking->driver->driver_detail->is_company == 'yes')
                                                        @php
                                                            $company = driver_company($booking->driver->driver_detail->company_id);
                                                        @endphp
                                ...
                                <div class = "col-md-4">
                                    ...
                                    <table class = "table table-striped">
                                        <tr>
                                            <th>Quoted Amount: </th>
                                            <td>{{ number_format($booking->qouted_amount,2)}} </td>
                                        </tr>
                                       <!--  <tr>
                                            <th>Commission: </th>
                                            <td>{{ get_commission_amount($booking->qouted_amount,$booking->comission_amount).'  '.'('. $booking->comission_amount.'%'.')'}} </td>
                                        </tr> -->
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ number_format($booking->received_amount,2)}} </td>
                                        </tr>
                                        <tr>
                                            <th>Balance Payment: </th>
                                            <td>{{ number_format($booking->total_amount - $booking->received_amount,2)}} </td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
