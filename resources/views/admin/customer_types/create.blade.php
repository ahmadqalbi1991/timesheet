...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <form id="admin_form" method="post" action="{{route('customer_types.submit')}}" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="form-label">Customer Type Status<span class="text-danger">*</span></label>
                                <select class="form-control jqv-input" data-jqv-required="true" name="customer_type_status">
                                    <option @if($customer_type_status=='active') selected @endif value="active">Active</option>
                                    <option @if($customer_type_status=='inactive') selected @endif value="inactive">InActive</option>
                                </select>
                            </div>
