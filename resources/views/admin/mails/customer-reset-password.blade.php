                                    ...
                                    <div style="padding: 15px 20px; background:#ffffff; padding-bottom: 15px;">
                                        <table style="background:#ffffff; font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;width: 100%;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 style="color: #1e1e1e;line-height: 42px; font-size: 30px;padding-right: 20px;">Reset Your {{ env('APP_NAME') }} Password</h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#636363;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                            <h4 style="font-weight: 600; font-size: 28px; color: #1e1e1e;margin-top: 0px">Dear <span style="color: #ED622F;">{{$user->name}},</span> </h4>
                                                            ...
                                                            <div style="margin: 25px auto;">
                                                                <a href="{{ route('user.reset.password',['token' => $user->token]) }}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; margin: 15px auto; font-size: 18px; border-radius: 8px;display: block; width: 235px; font-weight: 700;line-height: 50px; background: #ED622F; color: #ffffff; text-align: center;">
                                                                    Reset your password
                                                                </a>
                                                            </div>
