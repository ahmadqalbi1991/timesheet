...
$deligate = \App\Models\Deligate::where('id',$booking->deligate_id)->first();
  ...
  <body style="margin: 0; color: #f2f2f2">
    ...
    text-align: left;">
                                            ...
                                            'ltl' || $booking->deligate_type ==
                                            'lcl' || $booking->deligate_id == 2)
                                            <tr>
                                          ...
                                          <table style="width: 100%;height:1px; margin-top:15px" >
                                            <tbody>
                                              <tr>
                                                ...
                                                @if($booking->is_collection == 1)
                                                  <table class="booking-table" style=" border: 1px solid #ccc;border-collapse: collapse;width: 100%; height:100%;">
                                                    <tbody>
                                                      <tr>
                                                        <td style="text-align: left;border: 0px solid #ccc;padding:10px; font-weight: 700;    background: #008645;color: white;height: 25px;">
                                                         <strong>
                                                          Collection Address
                                                         </strong>
                                                        </td>
                                                      ...
                                                      <tr>
                                                        <td style="border: 1px solid #ccc;padding:10px; font-weight: 700; text-align: left;vertical-align: top;">
                                                          <div>
    ...
    text-decoration: underline;">View Map</button></a>
                                                ...
                                                @if(!empty($data['booking']->deliver_address))
                                                  <table class="booking-table" style=" border: 1px solid #ccc;border-collapse: collapse;width: 100%;height:100%;">
                                                    <tbody>
                                                      <tr>
                                                        <td style="text-align: left;border: 0px solid #ccc;padding:10px; font-weight: 700;    background: #ed622f;color: white;height: 25px;">
                                                         <strong>
                                                          Deliver Address
                                                         </strong>
                                                        </td>
