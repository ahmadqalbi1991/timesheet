                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <select class="form-control jqv-input" data-jqv-required="true" name="type">
                                    <option @if($type=='ftl') selected @endif value="ftl">FTL</option>
                                    <option @if($type=='ltl') selected @endif value="ltl">LTL</option>
                                </select>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="mb-3">
                                <label class="form-label" for="bs-validation-name">Max Weight in Tons<span class="text-danger">*</span> </label>
                                <input
                                    type="text"
                                    class="form-control jqv-input" data-jqv-required="true"
                                    id="max_weigt"
