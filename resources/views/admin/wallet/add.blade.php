...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <form id="admin_form" method="post" action="{{route('wallet.add.amt')}}" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <label class="form-label" for="bs-validation-name">Existing Amount</label>
                                <input
                                    type="number"
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <label class="form-label" for="bs-validation-name">Add New Amount<span class="text-danger">*</span> </label>
                                <input
                                    type="number"
                                    class="form-control jqv-input" data-jqv-required="true"
                                    id="add_amount"
