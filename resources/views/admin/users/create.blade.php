                ...
                <div class="row">
                    ...
                    --}}
                        ...
                        <div class="col-md-12 col-sm-12 py-4">
                            <form id="admin_form" action = "{{ route('users.submit') }}" method = "POST" enctype="multipart/form-data">
                                @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label">User Role</label>
                                    <select class="form-control-plaintext" name = "role" data-jqv-required="true">
