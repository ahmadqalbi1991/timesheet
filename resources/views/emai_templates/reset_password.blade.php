                                                    ...
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#636363;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                            ...
                                                            <div style="margin: 25px auto;">
                                                                <a href="{{$link}}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; margin: 15px auto; font-size: 18px; border-radius: 8px;display: block; width: 235px; font-weight: 700;line-height: 50px; background: #ED622F; color: #ffffff; text-align: center;">
                                                                    Reset your password
                                                                </a>
                                                            </div>
